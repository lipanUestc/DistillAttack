...
def distill(epochs, teacher, student, trainloader, testloader, temp):
    ...
    optimizer = torch.optim.Adam(student.parameters(), lr=8e-4)
    ...
    for epoch in range(START, START + epochs):
        ...
        if acc > best_acc:
            ...
            torch.save(checkpoint, f"/home/lpz/MHL/model-watermarking-main/d4/backup-{DATASET}-{acc}.pth")
            best_acc = acc
            best_epoch = epoch
            best_loss = loss
...
if __name__ == '__main__':    
    ...
    sd = torch.load("/home/lpz/MHL/model-watermarking-main/checkpoint/Privacy_cf10_SGD_CosineAnnealingLR_20.pth")
