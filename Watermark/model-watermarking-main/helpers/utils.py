...
def get_channels(dataset):
    if dataset == 'cifar10' or dataset == 'cifar100' or dataset == 'imagenet' or dataset == 'stl10' or dataset == 'fashionmnist':
        return 3
...
def get_size(dataset):
    if dataset == 'cifar10' or dataset == 'cifar100' or dataset == 'stl10'  or dataset == 'fashionmnist':
        return 32, 32
