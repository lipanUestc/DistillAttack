...
parser.add_argument('--trg_set_size', default=10, type=int, help='the size of the trigger set (default: 100)')
...
if args.method == 'ProtectingIP':
    ...
    dataset, _, _ = get_dataset(args.dataset, "/home/lpz/MHL/data/", "/home/lpz/MHL/data/",
    ...
    net.load_state_dict(torch.load('./checkpoint/' + args.loadmodel + '.pth'))
    net.to(device)
