...
def get_dataloader(dataset='cifar10', batch_size=128, num_workers=4, augment=True, data_path='/home/lpz/MHL/data/'):
...
def get_soft_label_dataloader(soft_label, dataset='cifar10', batch_size=128, num_workers=4, augment=True, data_path='/home/lpz/MHL/data/'):
